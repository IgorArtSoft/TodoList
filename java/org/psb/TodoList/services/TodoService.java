...
/**
 * This service will utilize plain jdbc calls. 
 * It will not utilize ORM or JPA.
 * 
...
public class TodoService {
	...
	Optional<ToDo> todoItemOptional = todoListRepository.getTodoById( id );
	return todoItemOptional.orElseThrow(() -> new ToDoListException( "User not found" ) );	
    }
     ...
     */
    public int createNewTodo(ToDo todoData) {
	int todoInserted = todoListRepository.insertNewTodo( todoData );
	return todoInserted;
    }
